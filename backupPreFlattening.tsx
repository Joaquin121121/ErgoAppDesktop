    ...
    case "CALCULATE_AVERAGES": {
      if (state.testType === "bosco") {
        ...
        if (state.selectedAthletes.length > 0) {
          return {
            ...state,
            multipleAthletesTests: state.multipleAthletesTests.map(
              (athleteTest, index) =>
                index === state.athletePointer &&
                athleteTest.test.results.type === "bosco"
                  ? {
                      ...athleteTest,
                      test: {
                        ...athleteTest.test,
                        results: {
                          ...athleteTest.test.results,
                          [boscoTests[state.testPointer]]: {
                            ...state.multipleAthletesTests[index].test.results[
                              boscoTests[state.testPointer]
                            ],
        ...
        if (state.selectedAthletes.length > 0) {
          return {
            ...
            multipleAthletesTests: state.multipleAthletesTests.map(
              (athleteTest, index) =>
                index === state.athletePointer &&
                athleteTest.test.results.type === "multipleDropJump"
                  ? {
                      ...athleteTest,
                      test: {
                        ...athleteTest.test,
                        results: {
                          ...athleteTest.test.results,
                          dropJumps: athleteTest.test.results.dropJumps.map(
                            (dropJump, index) =>
        ...
        if (state.selectedAthletes.length > 0) {
          return {
            ...
            multipleAthletesTests: state.multipleAthletesTests.map(
              (athleteTest, index) =>
                index === state.athletePointer &&
                athleteTest.test.results.type === "multipleJumps"
                  ? {
                      ...athleteTest,
                      test: {
                        ...athleteTest.test,
