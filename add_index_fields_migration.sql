-- Migration to add index fields to training_blocks and selected_exercises tables
-- This migration adds ordering functionality with unified indexing for session-level items

-- ========================================
-- ADD INDEX COLUMNS
-- ========================================

-- Add index column to training_blocks table
ALTER TABLE "training_blocks" ADD COLUMN "index" INTEGER NOT NULL DEFAULT 0;

-- Add index column to selected_exercises table  
ALTER TABLE "selected_exercises" ADD COLUMN "index" INTEGER NOT NULL DEFAULT 0;
...
-- ========================================
-- UNIFIED INDEX MANAGEMENT FUNCTIONS
-- ========================================
...
-- First, set index values for training_blocks and session-level selected_exercises using unified numbering
...
-- Set initial index values for existing block-level selected_exercises
UPDATE "selected_exercises" 
...
-- Verify unified session-level indexing (training_blocks and session-level selected_exercises should have unique indexes)
-- SELECT 
--     session_id,
...
-- Verify block-level selected_exercises indexing
